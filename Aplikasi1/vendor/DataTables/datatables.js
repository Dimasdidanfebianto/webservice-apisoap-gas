 ...
 *   https://datatables.net/download/#bs4/dt-1.11.3/fc-4.0.1/fh-3.2.0/r-2.2.9/sc-2.0.5/sb-1.3.0
 *
 * Included libraries:
 *   DataTables 1.11.3, FixedColumns 4.0.1, FixedHeader 3.2.0, Responsive 2.2.9, Scroller 2.0.5, SearchBuilder 1.3.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.11.3/fc-4.0.1/fh-3.2.0/r-2.2.9/sc-2.0.5/sb-1.3.0",
